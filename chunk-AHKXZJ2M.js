import {a as K0} from "./chunk-FCE2F4IL.js";
import {a as xe, b as it, c as Hc, d as Fc, f as zc, g as j0, i as ds, l as we, m as qc} from "./chunk-JOVT4LBN.js";
var Wc = zc( (rn, Vc) => {
    "use strict";
...
var Jc = /^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000)$/i;
function H0(e) {
...
var tl = typeof Blob == "function" || typeof Blob < "u" && Object.prototype.toString.call(Blob) === "[object BlobConstructor]"
  , nl = typeof ArrayBuffer == "function"
  , rl = e => typeof ArrayBuffer.isView == "function" ? ArrayBuffer.isView(e) : e && e.buffer instanceof ArrayBuffer
  , Tr = ({type: e, data: t}, n, r) => tl && t instanceof Blob ? n ? r(t) : Qc(t, r) : nl && (t instanceof ArrayBuffer || rl(t)) ? n ? r(t) : Qc(new Blob([t]), r) : r(_t[e] + (t || ""))
  , Qc = (e, t) => {
...
function il(e, t) {
    ...
    if (nl && (e.data instanceof ArrayBuffer || rl(e.data)))
        return t(el(e.data));
    Tr(e, !1, n => {
        fs || (fs = new TextEncoder),
        t(fs.encode(n))
    }
    )
}
var ol = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"
...
;
var q0 = typeof ArrayBuffer == "function"
  , Or = (e, t) => {
    if (typeof e != "string")
        return {
            type: "message",
            ...
            for (n.push(s); ; ) {
                if (r === 0) {
                    ...
                    if (Si(n) < i)
                        break;
                    let c = ki(n, i);
                    a.enqueue(Or(o ? c : ps.decode(c), t)),
                    r = 0
                }
                if (i === 0 || i > e) {
                    a.enqueue(Mr);
...
var G0 = Ge.setTimeout
  , Y0 = Ge.clearTimeout;
function Ht(e, t) {
    t.useNativeTimers ? (e.setTimeoutFn = G0.bind(Ge),
    e.clearTimeoutFn = Y0.bind(Ge)) : (e.setTimeoutFn = Ge.setTimeout.bind(Ge),
    e.clearTimeoutFn = Ge.clearTimeout.bind(Ge))
}
var Z0 = 1.33;
function pl(e) {
    return typeof e == "string" ? J0(e) : Math.ceil((e.byteLength || e.size) * Z0)
}
function J0(e) {
    let t = 0
      , n = 0;
...
var Lr = class extends Ft {
    ...
    onData(t) {
        ...
        ;
        ul(t, this.socket.binaryType).forEach(n),
...
var yl = !1;
try {
    yl = typeof XMLHttpRequest < "u" && "withCredentials"in new XMLHttpRequest
} catch {}
var vl = yl;
function X0() {}
    ...
    class e extends Ae {
        ...
        _cleanup(n) {
            if (!(typeof this._xhr > "u" || this._xhr === null)) {
                if (this._xhr.onreadystatechange = X0,
                n)
                    try {
                        this._xhr.abort()
                    } catch {}
...
if (typeof document < "u") {
    if (typeof attachEvent == "function")
        attachEvent("onunload", bl);
    else if (typeof addEventListener == "function") {
        let e = "onpagehide"in Ge ? "pagehide" : "unload";
        addEventListener(e, bl, !1)
    }
}
function bl() {
...
var Q0 = function() {
  ...
  , on = class extends gs {
    constructor(t) {
        ...
        this.supportsBinary = Q0 && !n
    }
    request(t={}) {
        return Object.assign(t, {
            xd: this.xd
        }, this.opts),
        new Ti(wl,this.uri(),t)
    }
}
;
function wl(e) {
    let t = e.xdomain;
    try {
        if (typeof XMLHttpRequest < "u" && (!t || vl))
...
var El = typeof navigator < "u" && typeof navigator.product == "string" && navigator.product.toLowerCase() === "reactnative"
  , vs = class extends Ft {
    get name() {
        return "websocket"
    }
    doOpen() {
        let t = this.uri()
          ...
          , r = El ? {} : xi(this.opts, "agent", "perMessageDeflate", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "localAddress", "protocolVersion", "origin", "maxPayload", "family", "checkServerIdentity");
  ...
  , ys = Ge.WebSocket || Ge.MozWebSocket
  , sn = class extends vs {
    createSocket(t, n, r) {
        return El ? new ys(t,n,r) : n ? new ys(t,n) : new ys(t)
    }
    doWrite(t, n) {
        this.ws.send(n)
    }
    ...
    doOpen() {
        ...
        this._transport.ready.then( () => {
            this._transport.createBidirectionalStream().then(t => {
                let n = hl(Number.MAX_SAFE_INTEGER, this.socket.binaryType)
...
var ep = /^(?:(?![^:@\/?#]+:[^:@\/]*@)(http|https|ws|wss):\/\/)?((?:(([^:@\/?#]*)(?::([^:@\/?#]*))?)?@)?((?:[a-f0-9]{0,4}:){2,7}[a-f0-9]{0,4}|[^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/
...
function Zn(e) {
    ...
    o.ipv6uri = !0),
    o.pathNames = np(o, o.path),
    o.queryKey = rp(o, o.query),
    o
}
function np(e, t) {
    let n = /\/{2,9}/g
...
var ws = typeof addEventListener == "function" && typeof removeEventListener == "function"
  , Ri = [];
...
var Oi = ( () => {
    class e extends Ae {
        constructor(n, r) {
            ...
            typeof this.opts.query == "string" && (this.opts.query = gl(this.opts.query)),
            ws && (this.opts.closeOnBeforeunload && (this._beforeunloadEventListener = () => {
        ...
        _onClose(n, r) {
            if (this.readyState === "opening" || this.readyState === "open" || this.readyState === "closing") {
                ...
                ws && (this._beforeunloadEventListener && removeEventListener("beforeunload", this._beforeunloadEventListener, !1),
  ...
  , Jn = class extends Li {
    constructor(t, n={}) {
        ...
        (!r.transports || r.transports && typeof r.transports[0] == "string") && (r.transports = (r.transports || ["polling", "websocket", "webtransport"]).map(i => bs[i]).filter(i => !!i)),
        super(t, r)
    }
}
;
...
var op = typeof ArrayBuffer == "function"
  , sp = e => typeof ArrayBuffer.isView == "function" ? ArrayBuffer.isView(e) : e.buffer instanceof ArrayBuffer
  , Cl = Object.prototype.toString
  , ap = typeof Blob == "function" || typeof Blob < "u" && Cl.call(Blob) === "[object BlobConstructor]"
  , cp = typeof File == "function" || typeof File < "u" && Cl.call(File) === "[object FileConstructor]";
function Ir(e) {
    return op && (e instanceof ArrayBuffer || sp(e)) || ap && e instanceof Blob || cp && e instanceof File
}
function Pr(e, t) {
...
function Es(e, t) {
    ...
    if (Ir(e)) {
        ...
        let n = {};
        for (let r in e)
            Object.prototype.hasOwnProperty.call(e, r) && (n[r] = Es(e[r], t));
        return n
    }
    return e
}
function kl(e, t) {
    return e.data = _s(e.data, t),
...
function _s(e, t) {
    ...
    if (e && e._placeholder === !0) {
        ...
        for (let n in e)
            Object.prototype.hasOwnProperty.call(e, n) && (e[n] = _s(e[n], t));
    return e
}
var xl = ["connect", "connect_error", "disconnect", "disconnecting", "newListener", "removeListener"]
  , Al = 5
  , fe = function(e) {
  ...
  , Ss = class e extends Ae {
    ...
    add(t) {
        ...
        if (typeof t == "string") {
            ...
            let r = n.type === fe.BINARY_EVENT;
            r || n.type === fe.BINARY_ACK ? (n.type = r ? fe.EVENT : fe.ACK,
            this.reconstructor = new ks(n),
    ...
    static isPayloadValid(t, n) {
        ...
        case fe.CONNECT_ERROR:
            return typeof n == "string" || Pi(n);
        case fe.EVENT:
        case fe.BINARY_EVENT:
            return Array.isArray(n) && (typeof n[0] == "number" || typeof n[0] == "string" && xl.indexOf(n[0]) === -1);
        case fe.ACK:
        case fe.BINARY_ACK:
  ...
  , ks = class {
    ...
    takeBinaryData(t) {
        ...
        this.buffers.length === this.reconPack.attachments) {
            let n = kl(this.reconPack, this.buffers);
...
var up = Number.isInteger || function(e) {
...
function hp(e, t) {
    switch (e) {
    case fe.CONNECT:
        return t === void 0 || Pi(t);
    case fe.DISCONNECT:
        return t === void 0;
    case fe.EVENT:
        return Array.isArray(t) && (typeof t[0] == "number" || typeof t[0] == "string" && xl.indexOf(t[0]) === -1);
    case fe.ACK:
        return Array.isArray(t);
    case fe.CONNECT_ERROR:
        return typeof t == "string" || Pi(t);
    default:
        return !1
    }
}
function fp(e) {
    return lp(e.nsp) && dp(e.id) && hp(e.type, e.data)
}
function ot(e, t, n) {
    return e.on(t, n),
    function() {
...
var pp = Object.freeze({
  ...
  , Xn = class extends Ae {
    ...
    _addToQueue(t) {
        ...
        t.push( (i, ...o) => (this._queue[0],
        i !== null ? r.tryCount > this._opts.retries && (this._queue.shift(),
...
function Br(e, t) {
    ...
    e = void 0),
    t = t || {};
    let n = _l(e, t.path || "/socket.io"), r = n.source, i = n.id, o = n.path, s = Nr[i] && o in Nr[i].nsps, a = t.forceNew || t["force new connection"] || t.multiplex === !1 || s, c;
...
var Xe = typeof global < "u" ? global : typeof self < "u" ? self : typeof window < "u" ? window : {}
  , Ot = []
  , vt = []
  , gp = typeof Uint8Array < "u" ? Uint8Array : Array
  , ic = !1;
function qd() {
    ic = !0;
...
var vp = {}.toString
  , Wd = Array.isArray || function(e) {
    return vp.call(e) == "[object Array]"
}
;
...
function Gd(e, t, n, r) {
    ...
    return typeof ArrayBuffer < "u" && t instanceof ArrayBuffer ? function(i, o, s, a) {
        ...
        Z.TYPED_ARRAY_SUPPORT ? (i = o).__proto__ = Z.prototype : i = As(i, o),
        i
        ...
        if (o) {
            if (typeof ArrayBuffer < "u" && o.buffer instanceof ArrayBuffer || "length"in o)
                return typeof o.length != "number" || (a = o.length) != a ? Zt(i, 0) : As(i, o);
            if (o.type === "Buffer" && Wd(o.data))
                return As(i, o.data)
        }
        var a;
...
function As(e, t) {
    var n = t.length < 0 ? 0 : 0 | oc(t.length);
    e = Zt(e, n);
    for (var r = 0; r < n; r += 1)
        e[r] = 255 & t[r];
    return e
...
function Tl(e, t, n, r, i) {
    ...
    Lt(t))
        return t.length === 0 ? -1 : Rl(e, t, n, r, i);
    if (typeof t == "number")
        return t &= 255,
        Z.TYPED_ARRAY_SUPPORT && typeof Uint8Array.prototype.indexOf == "function" ? i ? Uint8Array.prototype.indexOf.call(e, t, n) : Uint8Array.prototype.lastIndexOf.call(e, t, n) : Rl(e, [t], n, r, i);
...
function _p(e, t, n, r) {
    return Qo(wo(t, e.length - n), e, n, r)
}
function Jd(e, t, n, r) {
...
function xp(e, t, n) {
    return t === 0 && n === e.length ? Ml(e) : Ml(e.slice(t, n))
}
function Xd(e, t, n) {
    ...
    return function(h) {
        ...
        for (var g = "", m = 0; m < f; )
            g += String.fromCharCode.apply(String, h.slice(m, m += Ol));
        return g
    }(r)
}
Z.poolSize = 8192,
...
Z.prototype.toString = function() {
    var e = 0 | this.length;
    return e === 0 ? "" : arguments.length === 0 ? Xd(this, 0, e) : wp.apply(this, arguments)
}
,
...
Z.prototype.indexOf = function(e, t, n) {
    return Tl(this, e, t, n, !0)
}
,
Z.prototype.lastIndexOf = function(e, t, n) {
    return Tl(this, e, t, n, !1)
}
,
Z.prototype.write = function(e, t, n, r) {
    ...
    for (var o = !1; ; )
        switch (r) {
        case "hex":
            return Ep(this, e, t, n);
        case "utf8":
        case "utf-8":
            return _p(this, e, t, n);
        case "ascii":
            return Jd(this, e, t, n);
        case "latin1":
        case "binary":
            return Cp(this, e, t, n);
        case "base64":
...
Z.prototype.writeDoubleLE = function(e, t, n) {
    return Pl(this, e, t, !0, n)
}
,
Z.prototype.writeDoubleBE = function(e, t, n) {
    return Pl(this, e, t, !1, n)
}
,
...
Z.prototype.fill = function(e, t, n, r) {
    ...
    typeof e == "number")
        ...
        var s = Lt(e) ? e : wo(new Z(e,r).toString())
          , a = s.length;
        for (o = 0; o < n - t; ++o)
            this[o + t] = s[o % a]
    }
...
function th(e) {
    return e != null && (!!e._isBuffer || Il(e) || function(t) {
        return typeof t.readFloatLE == "function" && typeof t.slice == "function" && Il(t.slice(0, 0))
    }(e))
}
function Il(e) {
...
$i.crypto = void 0,
$i.crypto = typeof globalThis == "object" && "crypto"in globalThis ? globalThis.crypto : void 0,
function(e) {
    Object.defineProperty(e, "__esModule", {
        value: !0
    }),
...
function ph(e, t=!1) {
    ...
    for (let i = 0; i < e.length; i++) {
        let {h: o, l: s} = lc(e[i], t);
        [n[i],r[i]] = [o, s]
    }
    return [n, r]
}
var mh = (e, t) => BigInt(e >>> 0) << fa | BigInt(t >>> 0);
he.toBig = mh;
var gh = (e, t, n) => e >>> n;
he.shrSH = gh;
var yh = (e, t, n) => e << 32 - n | t >>> n;
he.shrSL = yh;
var vh = (e, t, n) => e >>> n | t << 32 - n;
he.rotrSH = vh;
var bh = (e, t, n) => e << 32 - n | t >>> n;
he.rotrSL = bh;
var wh = (e, t, n) => e << 64 - n | t >>> n - 32;
he.rotrBH = wh;
var Eh = (e, t, n) => e >>> n - 32 | t << 64 - n;
he.rotrBL = Eh;
var _h = (e, t) => t;
he.rotr32H = _h;
var Ch = (e, t) => e;
he.rotr32L = Ch;
var Sh = (e, t, n) => e << n | t >>> 32 - n;
he.rotlSH = Sh;
var kh = (e, t, n) => t << n | e >>> 32 - n;
he.rotlSL = kh;
var xh = (e, t, n) => t << n - 32 | e >>> 64 - n;
he.rotlBH = xh;
var Ah = (e, t, n) => e << n - 32 | t >>> 64 - n;
function Mh(e, t, n, r) {
    let i = (t >>> 0) + (r >>> 0);
    return {
        h: e + n + (i / 2 ** 32 | 0) | 0,
...
he.rotlBL = Ah;
var Th = (e, t, n) => (e >>> 0) + (t >>> 0) + (n >>> 0);
he.add3L = Th;
var Rh = (e, t, n, r) => t + n + r + (e / 2 ** 32 | 0) | 0;
he.add3H = Rh;
var Oh = (e, t, n, r) => (e >>> 0) + (t >>> 0) + (n >>> 0) + (r >>> 0);
he.add4L = Oh;
var Lh = (e, t, n, r, i) => t + n + r + i + (e / 2 ** 32 | 0) | 0;
he.add4H = Lh;
var Ph = (e, t, n, r, i) => (e >>> 0) + (t >>> 0) + (n >>> 0) + (r >>> 0) + (i >>> 0);
he.add5L = Ph;
var Ih = (e, t, n, r, i, o) => t + n + r + i + o + (e / 2 ** 32 | 0) | 0;
he.add5H = Ih;
var Bp = {
    fromBig: lc,
    split: ph,
  ...
  , Kn = class extends Dp.HashMD {
    ...
    process(t, n) {
        ...
        for (let E = 16; E < 80; E++) {
            let N = 0 | an[E - 15]
              , I = 0 | cn[E - 15]
              , F = pe.default.rotrSH(N, I, 1) ^ pe.default.rotrSH(N, I, 8) ^ pe.default.shrSH(N, I, 7)
              , q = pe.default.rotrSL(N, I, 1) ^ pe.default.rotrSL(N, I, 8) ^ pe.default.shrSL(N, I, 7)
              , z = 0 | an[E - 2]
              , G = 0 | cn[E - 2]
              , U = pe.default.rotrSH(z, G, 19) ^ pe.default.rotrBH(z, G, 61) ^ pe.default.shrSH(z, G, 6)
              , P = pe.default.rotrSL(z, G, 19) ^ pe.default.rotrBL(z, G, 61) ^ pe.default.shrSL(z, G, 6)
              , L = pe.default.add4L(q, P, cn[E - 7], cn[E - 16])
              , M = pe.default.add4H(L, F, U, an[E - 7], an[E - 16]);
            an[E] = 0 | M,
            cn[E] = 0 | L
        }
        let {Ah: r, Al: i, Bh: o, Bl: s, Ch: a, Cl: c, Dh: l, Dl: u, Eh: d, El: h, Fh: f, Fl: g, Gh: m, Gl: v, Hh: p, Hl: S} = this;
        for (let E = 0; E < 80; E++) {
            let N = pe.default.rotrSH(d, h, 14) ^ pe.default.rotrSH(d, h, 18) ^ pe.default.rotrBH(d, h, 41)
              , I = pe.default.rotrSL(d, h, 14) ^ pe.default.rotrSL(d, h, 18) ^ pe.default.rotrBL(d, h, 41)
              , F = d & f ^ ~d & m
              , q = h & g ^ ~h & v
              , z = pe.default.add5L(S, I, q, jp[E], cn[E])
              , G = pe.default.add5H(z, p, N, F, $p[E], an[E])
              , U = 0 | z
              , P = pe.default.rotrSH(r, i, 28) ^ pe.default.rotrBH(r, i, 34) ^ pe.default.rotrBH(r, i, 39)
              , L = pe.default.rotrSL(r, i, 28) ^ pe.default.rotrBL(r, i, 34) ^ pe.default.rotrBL(r, i, 39)
              , M = r & o ^ r & a ^ o & a
              , T = i & s ^ i & c ^ s & c;
            p = 0 | m,
            S = 0 | v,
            ...
            f = 0 | d,
            g = 0 | h,
            {h: d, l: h} = pe.default.add(0 | l, 0 | u, 0 | G, 0 | U),
            l = 0 | a,
            u = 0 | c,
            a = 0 | o,
            c = 0 | s,
            o = 0 | r,
            s = 0 | i;
            let D = pe.default.add3L(U, L, T);
            r = pe.default.add3H(D, G, P, M),
            i = 0 | D
        }
        ({h: r, l: i} = pe.default.add(0 | this.Ah, 0 | this.Al, 0 | r, 0 | i)),
        {h: o, l: s} = pe.default.add(0 | this.Bh, 0 | this.Bl, 0 | o, 0 | s),
        {h: a, l: c} = pe.default.add(0 | this.Ch, 0 | this.Cl, 0 | a, 0 | c),
        {h: l, l: u} = pe.default.add(0 | this.Dh, 0 | this.Dl, 0 | l, 0 | u),
        {h: d, l: h} = pe.default.add(0 | this.Eh, 0 | this.El, 0 | d, 0 | h),
        {h: f, l: g} = pe.default.add(0 | this.Fh, 0 | this.Fl, 0 | f, 0 | g),
        {h: m, l: v} = pe.default.add(0 | this.Gh, 0 | this.Gl, 0 | m, 0 | v),
        {h: p, l: S} = pe.default.add(0 | this.Hh, 0 | this.Hl, 0 | p, 0 | S),
...
Be.SHA384 = xo,
Be.sha512 = (0,
Ki.wrapConstructor)( () => new Kn),
Be.sha512_224 = (0,
Ki.wrapConstructor)( () => new So),
Be.sha512_256 = (0,
Ki.wrapConstructor)( () => new ko),
Be.sha384 = (0,
Ki.wrapConstructor)( () => new xo);
var pa = {}
  , sr = {}
  , ke = {}
  , me = {};
...
me.notImplemented = me.bitMask = void 0,
me.isBytes = Ao,
me.abytes = Mo,
me.abool = function(e, t) {
    if (typeof t != "boolean")
        throw new Error(`${e} must be valid boolean, got "${t}".`)
}
,
me.bytesToHex = Rs,
me.numberToHexUnpadded = Nl,
me.hexToNumber = Os,
me.hexToBytes = no,
me.bytesToNumberBE = function(e) {
    return Os(Rs(e))
}
,
me.bytesToNumberLE = function(e) {
    return Mo(e),
    Os(Rs(Uint8Array.from(e).reverse()))
}
,
me.numberToBytesBE = Dl,
me.numberToBytesLE = function(e, t) {
    return Dl(e, t).reverse()
}
,
me.numberToVarBytesBE = function(e) {
    return no(Nl(e))
}
,
me.ensureBytes = function(e, t, n) {
    let r;
    if (typeof t == "string")
        try {
            r = no(t)
...
,
me.bitGet = function(e, t) {
    return e >> BigInt(t) & to
}
,
me.bitSet = function(e, t, n) {
    return e | (n ? to : ma) << BigInt(t)
}
,
me.createHmacDrbg = function(e, t, n) {
...
,
me.validateObject = function(e, t, n={}) {
    let r = (i, o, s) => {
        let a = Hp[o];
        if (typeof a != "function")
...
function no(e) {
    ...
    o += 2) {
        let s = Bl(e.charCodeAt(o))
          , a = Bl(e.charCodeAt(o + 1));
...
function Dl(e, t) {
    return no(e.toString(16).padStart(2 * t, "0"))
}
function $l(...e) {
    let t = 0;
    for (let r = 0; r < e.length; r++) {
...
var Ls = e => typeof e == "bigint" && ma <= e;
function jl(e, t, n) {
    return Ls(e) && Ls(t) && Ls(n) && t <= e && e < n
}
me.bitMask = e => (Kp << BigInt(e - 1)) - to;
var Ps = e => new Uint8Array(e)
  , Kl = e => Uint8Array.from(e)
  , Hp = {
    bigint: e => typeof e == "bigint",
    function: e => typeof e == "function",
    boolean: e => typeof e == "boolean",
    string: e => typeof e == "string",
    stringOrUint8Array: e => typeof e == "string" || Ao(e),
...
ke.validateField = function(e) {
    let t = zp.reduce( (n, r) => (n[r] = "function",
    n), {
        ORDER: "bigint",
        MASK: "bigint",
        BYTES: "isSafeInteger",
...
ke.FpDiv = function(e, t, n) {
    return e.mul(t, typeof n == "bigint" ? Ui(n, e.ORDER) : e.inv(n))
}
,
ke.FpLegendre = Vl,
...
ke.Field = function(e, t, n=!1, r={}) {
    ...
    let {nBitLength: i, nByteLength: o} = Is(e, t);
    if (o > 2048)
...
,
ke.getFieldBytesLength = ya,
ke.getMinHashLength = Wl,
...
var zp = ["create", "isValid", "is0", "neg", "inv", "sqrt", "sqr", "eql", "add", "sub", "mul", "pow", "div", "addN", "subN", "mulN", "sqrN"];
function zl(e, t, n) {
    if (n < De)
...
gn.expand_message_xmd = Dh,
gn.expand_message_xof = $h,
gn.hash_to_field = $s,
    ...
    function h(m, v) {
        let p = function(N) {
          ...
          , E = function(N, I) {
            ...
            let F = I, q = N, z, G = js, U = er, P = N, L = js, M = er;
...
(function(e) {
    ...
    function P(x) {
        let {xMn: k, xMd: O, yMn: $, yMd: K} = function(ie) {
            ...
            let us = E.eql(de, be)
              ...
              , kr = E.cmov(B0, Uc, us)
              , $0 = E.isOdd(kr);
            return kr = E.cmov(kr, E.neg(kr), us !== $0),
            {
                xMn: D0,
                xMd: ve,
                yMn: kr,
    ...
    function w(x) {
        ...
        let ce = $(V * (K - d) * _ - X)
          ...
          , ue = $(d - ie)
          , ve = $(d + ie);
        return new e.ed25519.ExtendedPoint($(ne * ve),$(ue * ae),$(ae * ve),$(ne * ue))
    }
    class y {
        constructor(k) {
            this.ep = k
        ...
        static fromHex(k) {
            ...
            let ye = H(re * ge)
              , be = H(de * ye);
            if (!ae || (0,
            o.isNegativeLE)(be, K) || ye === u)
                throw new Error(V);
            return new y(new e.ed25519.ExtendedPoint(de,ye,d,be))
        }
        toRawBytes() {
            ...
            return {
                ...
                k2sig: function(ne) {
                    ...
                    if (!U(ae))
                        return;
                    let ue = F(ae)
                      , ve = q.BASE.multiply(ae).toAffine()
                      , ge = I(ve.x);
                    if (ge === c)
                        return;
                    let de = I(ue * I(ie + ge * re));
                    if (de === c)
                        return;
                    let ye = (ve.x === ge ? 0 : 2) | Number(ve.y & l)
                      , be = de;
...
ro.getHash = eu,
ro.createCurve = function(e, t) {
    let n = r => (0,
    Qp.weierstrass)(xe(xe({}, e), eu(r)));
...
var Us = new Uint8Array([0])
  , nu = new Uint8Array;
function Fh(e, t, n, r=32) {
    if ((0,
    Ea.hash)(e),
    (0,
    Ea.number)(r),
    ...
    let o = new Uint8Array(i * e.outputLen)
      , s = Uh.hmac.create(e, t)
      , a = s._cloneInto()
      , c = new Uint8Array(s.outputLen);
    for (let l = 0; l < i; l++)
        Us[0] = l + 1,
        a.update(l === 0 ? nu : c).update(n).update(Us).digestInto(c),
...
ar.hkdf = (e, t, n, r, i) => Fh(e, Hh(e, t, n), r, i),
function(e) {
    Object.defineProperty(e, "__esModule", {
        value: !0
    }),
...
var To = class {
    ...
    update(t) {
        ...
        return i && (hc.set(t.subarray(r * Vt)),
  ...
  , _a = class extends To {
    ...
    update(t) {
        ...
        return r && (hc.set(t.subarray(i * Vt)),
...
Nn.ghash = iu( (e, t) => new To(e,t)),
Nn.polyval = iu( (e, t) => new _a(e,t)),
...
var Sa = ( () => {
  ...
  , t1 = Sa.map( (e, t) => Sa.indexOf(t))
  , n1 = e => e << 24 | e >>> 8
  , Hs = e => e << 8 | e >>> 24
  , Ro = e => e << 24 & 4278190080 | e << 8 & 16711680 | e >>> 8 & 65280 | e >>> 24 & 255;
function qh(e, t) {
    if (e.length !== 256)
...
var pc = qh(Sa, e => cr(e, 3) << 24 | e << 16 | e << 8 | cr(e, 2))
  , Vh = qh(t1, e => cr(e, 11) << 24 | cr(e, 13) << 16 | cr(e, 9) << 8 | cr(e, 14))
  , r1 = ( () => {
...
function xt(e) {
    ...
    for (let c = o; c < a.length; c++) {
        let l = a[c - 1];
        c % o == 0 ? l = s(n1(l)) ^ r1[c / o - 1] : o > 6 && c % o == 4 && (l = s(l)),
        a[c] = a[c - o] ^ l
    }
    return (0,
    Q.clean)(...r),
...
Q.wrapCipher)({
    ...
    function o() {
        ...
        t.length === 12)
            ...
            let d = Ca.ghash.create(a).update(t).update(l);
            d.digestInto(c),
            d.destroy()
        }
        return {
...
Q.wrapCipher)({
    ...
    let r = zi("AAD", 0, 68719476736)
      , i = zi("plaintext", 0, 2 ** 36)
      , o = zi("nonce", 12, 12)
      , s = zi("ciphertext", 16, 2 ** 36 + 16);
    function a() {
        let u = xt(e)
...
Q.wrapCipher)({
    ...
    decrypt(t) {
        ...
        if (Oo.decrypt(e, n),
        !(0,
        Q.equalBytes)(n.subarray(0, 8), lu))
    ...
    (a, c, l, u, d=0) => {
        ...
        return function(N, I, F, q, z, G, U, P) {
            ...
            for (let _ = 0; _ < L; U++) {
                ...
                U >= du)
                    throw new Error("arx: counter overflow");
                let C = Math.min(qi, L - _);
                if (D && C === qi) {
                    let A = _ / 4;
                    if (_ % 4 != 0)
                        throw new Error("arx: invalid block position");
                    for (let R, w = 0; w < a1; w++)
                        R = A + w,
                        b[R] = j[R] ^ T[w];
                    _ += qi
                } else {
...
var qt = ze
  , yt = ht
  , ef = e => Uint8Array.from(e.split("").map(t => t.charCodeAt(0)))
  , i1 = ef("expand 16-byte k")
  , o1 = ef("expand 32-byte k")
  , s1 = (0,
yt.u32)(i1)
  , tf = (0,
yt.u32)(o1);
...
Lo.xchacha20 = void 0;
var tr, fu, $r, c1 = Qh;
Lo.xchacha20 = function(e, t, n) {
    return (0,
    c1.xchacha20poly1305)(e, t, n)
}
,
function(e) {
    Object.defineProperty(e, "__esModule", {
...
tr = ts,
fu = Et && Et.__createBinding || (Object.create ? function(e, t, n, r) {
    r === void 0 && (r = n);
...
$r = Et && Et.__exportStar || function(e, t) {
    for (var n in e)
        n === "default" || Object.prototype.hasOwnProperty.call(t, n) || fu(t, e, n)
}
,
...
var pu = ht
  ...
  , l1 = function() {
    ...
    Object.defineProperty(e.prototype, "uncompressed", {
        get: function() {
            return Z.from((0,
            Wi.convertPublicKeyFormat)(this.data, !1))
        },
        enumerable: !1,
        configurable: !0
    }),
    ...
    e.prototype.toHex = function(t) {
        return t === void 0 && (t = !0),
        (0,
        pu.bytesToHex)(t ? this.data : this.uncompressed)
    }
    ,
...
var mu = ht
  ...
  , d1 = function() {
    function e(t) {
        ...
        this.publicKey = new u1.PublicKey((0,
    ...
    e.prototype.equals = function(t) {
        return (0,
        mu.equalBytes)(this.data, t.data)
    }
    ,
    e
}();
...
var W = {
    ...
    SocketService: of,
    Ecies: sf,
    RemoteCommunication: af
}, jr, Gi = [], zs = [], tn = (e, t) => J(void 0, void 0, void 0, function*() {
    jr = t,
    zs.push(e),
    function(n) {
        return J(this, void 0, void 0, function*() {
            ...
            W.RemoteCommunication(`[sendBufferedEvents] Sending ${Gi.length} analytics events to ${r}`);
            try {
                let s = yield(0,
                rc.default)(r, {
                    method: "POST",
...
}, vr = "https://metamask-sdk.api.cx.metamask.io/", h1 = ["websocket"], br = 6048e5, f1 = 3e3, p1 = {
...
(Po || (Po = {})).KEY_EXCHANGE = "key_exchange",
function(e) {
...
var xa = class extends _r.EventEmitter2 {
    constructor({communicationLayer: t, otherPublicKey: n, context: r, ecies: i, logging: o}) {
        ...
        this.communicationLayer.on(Po.KEY_EXCHANGE, this.onKeyExchangeMessage.bind(this))
    }
...
var io = (e, t, n) => J(void 0, void 0, void 0, function*() {
    var r, i, o, s, a, c;
  ...
  , gu = (e, t, ...n) => J(void 0, [e, t, ...n], void 0, function*(r, i, o=200) {
  ...
  , Aa = e => J(void 0, void 0, void 0, function*() {
    let {state: t} = e
...
var uf = ["eth_sendTransaction", "eth_signTypedData", "eth_signTransaction", "personal_sign", "wallet_requestPermissions", "wallet_switchEthereumChain", "eth_signTypedData_v3", "eth_signTypedData_v4", "metamask_connectSign", "metamask_connectWith", "metamask_batch"].map(e => e.toLowerCase())
  , m1 = [{
      ...
      [SocketService handleMessage()] context=${e.state.context}::on 'message' error=${q}`),
            ...
            e.state.isOriginator && P.data) {
                ...
                if (M) {
                    ...
                    e.remote.state.analytics && uf.includes(M.method.toLowerCase()) && tn(Object.assign(Object.assign({
...
function yu(e, t) {
    ...
    m1.forEach( ({event: i, handler: o}) => {
        n?.on(`${i}-${t}`, o(e, t))
    }
    ),
    g1.forEach( ({event: i, handler: o}) => {
        r?.on(i, o(e))
    }
    ),
...
var Ma = class extends _r.EventEmitter2 {
    ...
    initSocket() {
        ...
        this.state.keyExchange = new xa(a)
    }
    resetKeys() {
        ...
        return J(this, void 0, void 0, function*() {
            return function(n, r) {
                return J(this, void 0, void 0, function*() {
                    ...
                    let a = yield lf(n, r);
                    return n.remote.state.analytics && n.remote.state.isOriginator && r.method && uf.includes(r.method.toLowerCase()) && tn({
                    ...
                    function(c, l) {
                        return J(this, void 0, void 0, function*() {
                            ...
                            if (c.state.isOriginator && d)
                                try {
                                    let f = gu(d, c.state.rpcMethodTracker, 200).then(v => ({
                                        type: dr.RPC_CHECK,
                                        result: v
                                    }))
                                      , g = J(this, void 0, void 0, function*() {
                                        let v = yield(S => J(void 0, [S], void 0, function*({rpcId: E, instance: N}) {
                                          ...
                                          , p = yield gu(v, c.state.rpcMethodTracker, 200);
                                        return {
                                            type: dr.SKIPPED_RPC,
                                            result: p
                                        }
...
function bu({communicationLayerPreference: e, otherPublicKey: t, reconnect: n, ecies: r, communicationServerUrl: i=vr, instance: o}) {
    ...
    let q = {
        [te.AUTHORIZED]: y1(o),
        [te.MESSAGE]: C1(o),
        [te.CHANNEL_PERSISTENCE]: x1(o),
        [te.CLIENTS_CONNECTED]: b1(o, e),
        [te.KEYS_EXCHANGED]: _1(o, e),
        [te.SOCKET_DISCONNECTED]: k1(o),
        [te.SOCKET_RECONNECT]: S1(o),
        [te.CLIENTS_DISCONNECTED]: w1(o),
        [te.KEY_INFO]: () => {}
        ,
        [te.CHANNEL_CREATED]: v1(o),
        [te.CLIENTS_WAITING]: E1(o),
        [te.RPC_UPDATE]: z => {
...
function df(e) {
    return J(this, arguments, void 0, function*({options: t, instance: n}) {
        ...
        new Promise( (i, o) => {
            ...
            t.sendMessage ? !((l = r.communicationLayer) === null || l === void 0) && l.getKeyInfo().keysExchanged && n.state.communicationLayer && lf(n.state.communicationLayer, {
                type: Te.TERMINATE
            }).then( () => {
                i(!0)
            }
...
var Ta = class extends _r.EventEmitter2 {
    constructor(t) {
        super(),
        this.state = {
            ready: !1,
...
function T1(e) {
    ...
    return (n, r, i) => {
        t.ethDecryptDeprecation || n.method !== "eth_decrypt" ? t.ethGetEncryptionPublicKeyDeprecation || n.method !== "eth_getEncryptionPublicKey" ? !t.walletWatchAssetNFTExperimental && n.method === "wallet_watchAsset" && [A1, M1].includes(n.params?.type || "") && (e.warn(Oe.warnings.rpc.walletWatchAssetNFTExperimental),
...
var mc = (e, t, n) => {
  ...
  , _n = (e, t, n) => (mc(e, t, "read from private field"),
n ? n.call(e) : t.get(e))
  , kt = (e, t, n) => {
    if (t.has(e))
  ...
  , Yi = (e, t, n, r) => (mc(e, t, "write to private field"),
t.set(e, n),
n)
  , Ye = (e, t, n) => (mc(e, t, "access private method"),
n)
  , vn = {
    invalidInput: -32e3,
...
var Io = (e, t) => Object.hasOwnProperty.call(e, t)
  , Ra = class extends TypeError {
    constructor(t, n) {
        let r, l = t, {message: i, explanation: o} = l, s = Fc(l, ["message", "explanation"]), {path: a} = t, c = a.length === 0 ? i : `At path: ${a.join(".")} -- ${i}`;
        super(o ?? c),
        o != null && (this.cause = c),
...
var dt = class {
    constructor(t) {
        ...
        this.entries = a,
        this.coercer = s,
        this.validator = i ? (c, l) => Cu(i(c, l), l, this, c) : () => [],
        this.refiner = o ? (c, l) => Cu(o(c, l), l, this, c) : () => []
    }
    assert(t, n) {
        return ff(t, this, n)
    }
...
function ci(e, t, n={}) {
    ...
    return i[0] ? [new Ra(i[0],function*() {
        for (let s of r)
            s[0] && (yield s[0])
    }
    ), void 0] : [void 0, i[1]]
...
function N1() {
    gr && Dn && (gr = !1,
    Dn.length ? Qt = Dn.concat(Qt) : oo = -1,
    Qt.length && Cf())
}
function Cf() {
    if (!gr) {
...
var B1 = Fn
  ...
  , H1 = Fn
  , or = Xe.performance || {}
  , F1 = or.now || or.mozNow || or.msNow || or.oNow || or.webkitNow || function() {
  ...
  , _e = {
    ...
    config: {},
    uptime: function() {
        return (new Date - z1) / 1e3
    }
}
  , li = e => vf(e);
function xu({path: e, branch: t}) {
    let n = e[e.length - 1];
    return Io(t[t.length - 2], n)
}
function No(e) {
    return new dt(it(xe({}, e), {
        type: `optional ${e.type}`,
        validator: (t, n) => !xu(n) || e.validator(t, n),
        refiner: (t, n) => !xu(n) || e.refiner(t, n)
    }))
}
var Zi, Au, Mu, Bo = ns([gf(null), Mn("boolean", e => typeof e == "boolean"), Mn("finite number", e => Cr(e, yf()) && Number.isFinite(e)), Tn(), mf(Su( () => Bo)), bf(Tn(), Su( () => Bo))]), ui = (Zi = Bo,
Au = Mn("any", () => !0),
Mu = e => (function(t, n, r="Assertion failed", i=I1) {
    try {
        ff(t, n)
    } catch (o) {
        throw P1(i, `${r}: ${L1(o)}.`)
...
new dt(it(xe({}, Zi), {
    coercer: (e, t) => Cr(e, Au) ? Zi.coercer(Mu(e, t), t) : Zi.coercer(e, t)
})));
function Oa(e) {
    try {
        return function(t) {
...
var Ou = vn.internal
  , W1 = "Unspecified error message. This is a bug, please report it."
  , G1 = {
    code: Ou,
    message: xf(Ou)
}
  , Y1 = "Unspecified server error.";
function xf(e, t=W1) {
    if (function(n) {
...
function Lu(e, {fallbackError: t=G1, shouldIncludeStack: n=!0}={}) {
    if (!Ru(t))
...
function Af(e) {
    return Array.isArray(e) ? e.map(t => Oa(t) ? t : _u(t) ? Pu(t) : null) : _u(e) ? Pu(e) : Oa(e) ? e : null
}
function Pu(e) {
...
function Fr(e, t, n, r) {
    ...
    Pa(e, "", 0, [], void 0, 0, r);
    try {
        i = $n.length === 0 ? JSON.stringify(e, t, n) : JSON.stringify(e, Of(t), n)
    } catch {
...
function Iu(e, t, n, r) {
    r === void 0 && (r = Rf());
    var i, o = Ia(e, "", 0, [], void 0, 0, r) || e;
    try {
        i = $n.length === 0 ? JSON.stringify(o, t, n) : JSON.stringify(o, Of(t), n)
    } catch {
        return JSON.stringify("[unable to serialize, circular reference is too complex to analyze]")
    } finally {
        for (; Hn.length !== 0; ) {
...
var J1 = es(Mf)
  , Wt = class extends Error {
    ...
    serialize() {
        ...
        }(this.data) && (e.data.cause = Af(this.data.cause))),
        this.stack && (e.stack = this.stack),
        e
    }
    toString() {
        return J1(this.serialize(), X1, 2)
    }
}
;
function X1(e, t) {
...
var Yr = e => Q1(vn.invalidRequest, e);
function Q1(e, t) {
    let[n,r] = function(i) {
        if (i) {
            if (typeof i == "string")
...
function Nu(e, t, n, r) {
    ...
    s) {
        ...
        !s.warned && (i = Pf(e)) && i > 0 && s.length > i) {
            s.warned = !0;
...
Ce.prototype.prependOnceListener = function(e, t) {
    if (typeof t != "function")
        throw new TypeError('"listener" argument must be a function');
    return this.prependListener(e, Bu(this, e, t)),
    this
}
,
...
var tm = class extends em.EventEmitter {
    emit(e, ...t) {
        let n = e === "error"
          , r = this._events;
        if (r !== void 0)
...
, $o, bn, hr, zr, ao, co, Na, lo, Ba, qs, ju, uo, Da, Vs, Ku, Zr, jo, Ws, Uu, If = Lf.default = tm, St = class ho extends If {
    ...
    push(t) {
        Ye(this, zr, ao).call(this),
        _n(this, bn).push(t)
    }
    handle(t, n) {
        if (Ye(this, zr, ao).call(this),
        n && typeof n != "function")
            throw new Error('"callback" must be a function if provided.');
        return Array.isArray(t) ? n ? Ye(this, co, Na).call(this, t, n) : Ye(this, co, Na).call(this, t) : n ? Ye(this, lo, Ba).call(this, t, n) : this._promiseHandle(t)
    }
    asMiddleware() {
        return Ye(this, zr, ao).call(this),
        (t, n, r, i) => we(this, null, function*() {
            var o, s;
            try {
                let[a,c,l] = yield Ye(o = ho, uo, Da).call(o, t, n, _n(this, bn));
                return c ? (yield Ye(s = ho, Zr, jo).call(s, l),
                i(a)) : r(u => we(this, null, function*() {
                    var d;
                    try {
                        yield Ye(d = ho, Zr, jo).call(d, l)
                    } catch (h) {
                        return u(h)
                    }
                    return u()
...
Ba = function(e, t) {
    return we(this, null, function*() {
        ...
        if (typeof e.method != "string") {
            ...
            return _n(this, hr) && !Tu(e) ? t(null) : t(s, {
                id: e.id ?? null,
                jsonrpc: "2.0",
                error: s
            })
        }
        if (_n(this, hr) && Cr(e, V1) && !Tu(e)) {
            try {
        ...
        try {
            yield Ye(n = St, qs, ju).call(n, i, o, _n(this, bn))
        } catch (s) {
            r = s
        }
        return r && (delete o.result,
        o.error || (o.error = Lu(r))),
        t(r, o)
    })
}
,
...
ju = function(e, t, n) {
    return we(this, null, function*() {
        var r, i, o;
        let[s,a,c] = yield Ye(r = St, uo, Da).call(r, e, t, n);
        if (Ye(i = St, Ws, Uu).call(i, e, t, a),
        yield Ye(o = St, Zr, jo).call(o, c),
        s)
            throw s
    })
}
...
Da = function(e, t, n) {
    return we(this, null, function*() {
        ...
        let i = []
          ...
          , s = !1;
        for (let a of n)
            if ([o,s] = yield Ye(r = St, Vs, Ku).call(r, e, t, a, i),
            s)
                break;
...
var Nf = Object.freeze(["eth_subscription"])
  , rm = (e=console) => [R1(), im(e), T1(e)];
function im(e) {
    return (t, n, r) => {
...
var fo = (e, t, n=!0) => (r, i) => {
  ...
  , Bf = e => !!e && typeof e == "string" && e.startsWith("0x")
  , Df = () => {}
;
function Hu(e, t) {
    return we(this, null, function*() {
...
var $f = (e, t, n) => {
  ...
  , It = (e, t, n) => ($f(e, t, "read from private field"),
n ? n.call(e) : t.get(e))
  , $a = (e, t, n) => {
    if (t.has(e))
        throw TypeError("Cannot add the same private member more than once");
  ...
  , Gt = (e, t, n, r) => ($f(e, t, "write to private field"),
t.set(e, n),
n);
function Fu(e, t, n) {
    try {
...
, mn, Pn, cm = function e(t, n) {
    ...
    return t != t && n != n
}, lm = es(cm), jf = class Kf extends ja {
    constructor({logger: t=console, maxEventListeners: n=100, rpcMiddleware: r=[]}={}) {
        ...
        this._state = xe({}, Kf._defaultState),
        Gt(this, Pn, null),
        Gt(this, mn, null),
    ...
    _handleAccountsChanged(t, n=!1) {
        ...
        if (!lm(this._state.accounts, r) && (n && this._state.accounts !== null && this._log.error("MetaMask: 'eth_accounts' unexpectedly updated accounts. Please report this bug.", r),
...
var vc, bc = yi(Pp);
vc = typeof Object.create == "function" ? function(e, t) {
    e.super_ = t,
...
;
var Hf = Object.getOwnPropertyDescriptors || function(e) {
...
function rs(e) {
    ...
    n = 1;
    for (var r = arguments, i = r.length, o = String(e).replace(dm, function(a) {
        if (a === "%%")
            return "%";
        if (n >= i)
            return a;
...
function wc(e, t) {
    if (Bt(Xe.process))
        return function() {
            return wc(e, t).apply(this, arguments)
        }
        ;
...
var Ys, Ji = {};
function Ff(e) {
    return Bt(Ys) && (Ys = _e.env.NODE_DEBUG || ""),
    e = e.toUpperCase(),
    !Ji[e] && (new RegExp("\\b" + e + "\\b","i").test(Ys) ? Ji[e] = function() {
        var t = rs.apply(null, arguments);
...
function Ko(e, t, n) {
    ...
    Uo(t) && (l = " " + Date.prototype.toUTCString.call(t)),
    Xr(t) && (l = " " + Zs(t)),
    ...
    c = u ? function(h, f, g, m, v) {
        for (var p = [], S = 0, E = f.length; S < E; ++S)
            Yf(f, String(S)) ? p.push(Js(h, f, g, m, String(S), !0)) : p.push("");
        return v.forEach(function(N) {
            N.match(/^\d+$/) || p.push(Js(h, f, g, m, N, !0))
        }),
        p
    }(e, t, n, s, o) : o.map(function(h) {
        return Js(e, t, n, s, h, u)
    }),
    e.seen.pop(),
    function(h, f, g) {
...
function Js(e, t, n, r, i, o) {
    ...
    Yf(r, i) || (s = "[" + i + "]"),
    a || (e.seen.indexOf(c.value) < 0 ? (a = vi(n) ? Ko(e, c.value, null) : Ko(e, c.value, n - 1)).indexOf(`
`) > -1 && (a = o ? a.split(`
`).map(function(l) {
        return "  " + l
    }).join(`
...
function Jr(e) {
    return zn(e) && Cc(e) === "[object RegExp]"
}
function zn(e) {
    return typeof e == "object" && e !== null
}
function Uo(e) {
    return zn(e) && Cc(e) === "[object Date]"
}
function Xr(e) {
    return zn(e) && (Cc(e) === "[object Error]" || e instanceof Error)
}
function Qr(e) {
...
var pm = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
function Gf() {
    console.log("%s - %s", function() {
        var e = new Date
          , t = [Xs(e.getHours()), Xs(e.getMinutes()), Xs(e.getSeconds())].join(":");
        return [e.getDate(), pm[e.getMonth()], t].join(" ")
...
function kc(e) {
    ...
    Object.defineProperties(t, Hf(e))
}
function mm(e, t) {
    if (!e) {
...
pt("ERR_INVALID_ARG_TYPE", function(e, t, n) {
    ...
    function(a, c, l) {
        ...
        o = "The ".concat(e, " ").concat(r, " ").concat(Zu(t, "type"));
    else {
        var s = function(a, c, l) {
            return typeof l != "number" && (l = 0),
            !(l + c.length > a.length) && a.indexOf(c, l) !== -1
        }(e, ".") ? "property" : "argument";
        o = 'The "'.concat(e, '" ').concat(s, " ").concat(r, " ").concat(Zu(t, "type"))
    }
...
qn.codes = Qf;
var ta, Ju, na, Xu, ra, Qu, vm = typeof Object.create == "function" ? function(e, t) {
    e.super_ = t,
    e.prototype = Object.create(t.prototype, {
        constructor: {
            value: e,
...
function t0() {
    ...
    var n = {
        deprecate: bm()
    }, r = Uf(), i = bc.Buffer, o = (Et !== void 0 ? Et : typeof window < "u" ? window : typeof self < "u" ? self : {}).Uint8Array || function() {}
    , s, a = Xf(), c = e0().getHighWaterMark, l = qn.codes, u = l.ERR_INVALID_ARG_TYPE, d = l.ERR_METHOD_NOT_IMPLEMENTED, h = l.ERR_MULTIPLE_CALLBACK, f = l.ERR_STREAM_CANNOT_PIPE, g = l.ERR_STREAM_DESTROYED, m = l.ERR_STREAM_NULL_VALUES, v = l.ERR_STREAM_WRITE_AFTER_END, p = l.ERR_UNKNOWN_ENCODING, S = a.errorOrDestroy;
    function E() {}
    function N(L, M, T) {
        t = t || wr(),
        L = L || {},
...
var wm = Z.isEncoding || function(e) {
...
function po(e) {
    ...
    case "utf16le":
        ...
        this.detectIncompleteChar = _m;
        break;
    case "base64":
        this.surrogateSize = 3,
        this.detectIncompleteChar = Cm;
        break;
    default:
        return void (this.write = Em)
    }
...
,
po.prototype.detectIncompleteChar = function(e) {
...
;
var ed = yi(Object.freeze({
    __proto__: null,
    StringDecoder: po
}))
  , td = qn.codes.ERR_STREAM_PREMATURE_CLOSE;
function Sm() {}
var ia, nd, rd, id, oa, od, xc = function e(t, n, r) {
    if (typeof n == "function")
        return e(t, null, n);
    n || (n = {}),
    r = function(g) {
    ...
    var i = n.readable || n.readable !== !1 && t.readable
      ...
      , h = function() {
        var g;
        return i && !l ? (t._readableState && t._readableState.ended || (g = new td),
        r.call(t, g)) : o && !a ? (t._writableState && t._writableState.ended || (g = new td),
        r.call(t, g)) : void 0
    }
      , f = function() {
        t.req.on("finish", c)
...
function n0() {
    ...
    }, n = Uf(), r = bc.Buffer, i = (Et !== void 0 ? Et : typeof window < "u" ? window : typeof self < "u" ? self : {}).Uint8Array || function() {}
    , o, s = Jf;
    o = s && s.debuglog ? s.debuglog("stream") : function() {}
    ;
    var a, c, l, u = ym(), d = Xf(), h = e0().getHighWaterMark, f = qn.codes, g = f.ERR_INVALID_ARG_TYPE, m = f.ERR_STREAM_PUSH_AFTER_EOF, v = f.ERR_METHOD_NOT_IMPLEMENTED, p = f.ERR_STREAM_UNSHIFT_AFTER_END_EVENT;
    bi(I, n);
    ...
    function N(w, y, x) {
        ...
        this.decoder = null,
        this.encoding = null,
        w.encoding && (a || (a = ed.StringDecoder),
...
var r0 = Yt
  , os = qn.codes
  , xm = os.ERR_METHOD_NOT_IMPLEMENTED
  , Am = os.ERR_MULTIPLE_CALLBACK
  , Mm = os.ERR_TRANSFORM_ALREADY_TRANSFORMING
  , Tm = os.ERR_TRANSFORM_WITH_LENGTH_0
  , mo = wr();
function Rm(e, t) {
...
function Yt(e) {
    ...
    this.on("prefinish", Om)
}
function Om() {
    var e = this;
    typeof this._flush != "function" || this._readableState.destroyed ? sd(this, null, null) : this._flush(function(t, n) {
        sd(e, t, n)
    })
}
function sd(e, t, n) {
...
Yt.prototype.push = function(e, t) {
    ...
    mo.prototype.push.call(this, e, t)
}
,
...
Yt.prototype._destroy = function(e, t) {
    mo.prototype._destroy.call(this, e, function(n) {
        t(n)
    })
}
;
...
;
var o0 = qn.codes
  , Pm = o0.ERR_MISSING_ARGS
  , Im = o0.ERR_STREAM_DESTROYED;
function ad(e) {
    if (e)
        throw e
}
...
var Bm = function() {
    for (var e = arguments.length, t = new Array(e), n = 0; n < e; n++)
        t[n] = arguments[n];
    var r, i = function(s) {
        return s.length ? typeof s[s.length - 1] != "function" ? ad : s.pop() : ad
    }(t);
    if (Array.isArray(t[0]) && (t = t[0]),
    t.length < 2)
        throw new Pm("streams");
        ...
        return function(l, u, d, h) {
            ...
            return function(m) {
                if (!f && !g)
                    ...
                    }(l) ? l.abort() : typeof l.destroy == "function" ? l.destroy() : void h(m || new Im("pipe"))
            }
        }(s, c, a > 0, function(l) {
            r || (r = l),
            l && o.forEach(cd),
...
Ua.exports = ld(Xi),
Ua.exports.strict = ld(ud),
Xi.proto = Xi(function() {
...
;
Fo.Substream = Ha;
var Um = Et && Et.__importDefault || function(e) {
...
Ho.ObjectMultiplex = void 0;
var aa = Er
  , Hm = Um(jm)
  , Fm = Fo
  , dd = Symbol("IGNORE_SUBSTREAM")
  , zm = class extends aa.Duplex {
    constructor(e={}) {
    ...
    _write(e, t, n) {
        ...
        return o ? (o !== dd && o.push(i),
        n()) : (console.warn(`ObjectMultiplex - orphaned data for stream "${r}"`),
        n())
    }
}
;
Ho.ObjectMultiplex = zm;
var qm = es(Ho.ObjectMultiplex)
...
var Rt, Vm = Tt, Wm = class extends um {
    constructor(e, {jsonRpcStreamName: t, logger: n=console, maxEventListeners: r=100, rpcMiddleware: i=[]}) {
        ...
        this._jsonRpcConnection.events.on("notification", s => {
            ...
            a === "metamask_accountsChanged" ? this._handleAccountsChanged(c) : a === "metamask_unlockStateChanged" ? this._handleUnlockStateChanged(c) : a === "metamask_chainChanged" ? this._handleChainChanged(c) : Nf.includes(a) ? this.emit("message", {
                type: a,
                data: c
...
${t.stack}`),
    ...
    _handleChainChanged({chainId: e, networkVersion: t}={}) {
        Bf(e) && (n => !!n && typeof n == "string")(t) ? t === "loading" ? this._handleDisconnect(!0) : super._handleChainChanged({
            chainId: e
...
, Gm = class extends Wm {
    constructor(e, {jsonRpcStreamName: t="metamask-provider", logger: n=console, maxEventListeners: r=100, shouldSendMetadata: i}={}) {
        ...
        this._jsonRpcConnection.events.on("notification", o => {
            let {method: s} = o;
            Nf.includes(s) && (this.emit("data", o),
            this.emit("notification", o.params.result))
        }
        ),
        i)
            if (document.readyState === "complete")
                Hu(this._rpcEngine, this._log);
            else {
                let o = () => {
                    Hu(this._rpcEngine, this._log),
...
var Ym = Mf
  , zo = class extends Error {
    ...
    toString() {
        return Ym.default(this.serialize(), Zm, 2)
    }
}
;
kn.EthereumRpcError = zo;
function Zm(e, t) {
    if (t !== "[Circular]")
        return t
}
kn.EthereumProviderError = class extends zo {
    constructor(e, t, n) {
        if (!function(r) {
...
function mt(e, t) {
    let[n,r] = c0(t);
    return new Mc.EthereumRpcError(e,n || a0.getMessageFromCode(e),r)
}
function Ur(e, t) {
    let[n,r] = c0(t);
    return new Mc.EthereumProviderError(e,n || a0.getMessageFromCode(e),r)
}
function c0(e) {
    if (e) {
        if (typeof e == "string")
...
qo.ethErrors = {
    ...
    provider: {
        ...
        custom: e => {
            ...
            if (!n || typeof n != "string")
                throw new Error('"message" must be a nonempty string');
            return new Mc.EthereumProviderError(t,n,r)
        }
    }
},
function(e) {
...
, Vo = class e {
    ...
    isMobile() {
        var t, n;
        let r = u0.parse(window.navigator.userAgent);
...
, d0 = e => J(void 0, void 0, void 0, function*() {
    if (Vo.isBrowser()) {
    ...
    handleDisconnect({terminate: t=!1}) {
        (function({terminate: n=!1, instance: r}) {
            ...
            r.emit("disconnect", s0.ethErrors.provider.disconnected()),
...
var hd = "direct", pi = "https://metamask.app.link/connect", mi = "metamask://connect", fd = {
    NAME: "MetaMask",
    RDNS: ["io.metamask", "io.metamask.flask"]
}, Jm = /(?:^[a-f0-9]{8}-[a-f0-9]{4}-4[a-f0-9]{3}-[a-f0-9]{4}-[a-f0-9]{12}$)|(?:^0{8}-0{4}-0{4}-0{4}-0{12}$)/u, le = {
    METAMASK_GETPROVIDERSTATE: "metamask_getProviderState",
    ...
    [le.METAMASK_BATCH]: !0,
    [le.METAMASK_OPEN]: !0
}, Xm = Object.keys(Wo).map(e => e.toLowerCase()), h0 = ["eth_signTypedData", "eth_signTypedData_v3", "eth_signTypedData_v4", "eth_sign"].map(e => e.toLowerCase()), ca = ".sdk-comm", Go = "providerType", za = ".MMSDK_cached_address", qa = ".MMSDK_cached_chainId", Mt = {
...
var e2 = typeof window < "u" && window.localStorage;
function t2({instance: e, msg: t}) {
    return J(this, void 0, void 0, function*() {
...
function pd(e) {
    ...
    return J(this, void 0, void 0, function*() {
        ...
        localStorage.setItem(Go, "extension"),
        e.extensionActive = !0,
    ...
    return J(this, void 0, void 0, function*() {
        ...
        try {
            ...
            if (!(!((N = e.state.platformManager) === null || N === void 0) && N.isMetaMaskInstalled()))
                ...
                r();
            Wo[D] ? (Y(`[RCPMS: _write()] redirect link for '${D}' socketConnected=${G} connect?${w}`),
...
var Va = class extends Er.Duplex {
  ...
  , r2 = ({checkInstallationOnAllCalls: e=!1, communicationLayerPreference: t, injectProvider: n, shouldShimWeb3: r, platformManager: i, installer: o, sdk: s, remoteConnection: a, debug: c}) => J(void 0, void 0, void 0, function*() {
    var l, u;
            ...
            try {
                let ee = (j = P?.[0]) === null || j === void 0 ? void 0 : j.params
                  , re = yield( ({rpcEndpoint: se, method: ce, sdkInfo: ie, params: ne}) => J(void 0, void 0, void 0, function*() {
                    ...
                    if (!ve.ok)
                        throw new Error(`Server responded with a status of ${ve.status}`);
                    return (yield ve.json()).result
                }))({
                    rpcEndpoint: X,
                    sdkInfo: g,
                    method: U,
        ...
        if ((!x || x && !k) && U !== le.METAMASK_GETPROVIDERSTATE) {
            ...
            if (H.indexOf(U) !== -1 || e) {
                ...
                try {
                    ...
                    if (jt.EXTENSION === ce) {
                        ...
                        if (U.toLowerCase() === le.METAMASK_CONNECTWITH.toLowerCase()) {
                            let[ie] = ee
                              , ne = yield( ({method: ae, sdk: ue, params: ve}) => J(void 0, void 0, void 0, function*() {
                                var ge, de, ye, be;
                                if (!ue.isExtensionActive())
                                    throw new Error("SDK state invalid -- extension is not active");
                                Y("[MetaMaskProvider: extensionConnectWithOverwrite()] Overwriting request method", ae, ve);
                                let Pe = yield(ge = ue.getProvider()) === null || ge === void 0 ? void 0 : ge.request({
                                    method: le.ETH_REQUESTACCOUNTS,
                                    params: []
                                });
                                if (!Pe.length)
                                ...
                                if (ae?.toLowerCase() === le.ETH_SENDTRANSACTION.toLowerCase()) {
                                    let ft = {
                                        method: ae,
                                        params: [Object.assign(Object.assign({}, ve[0]), {
                                            from: Pe[0]
                                        })]
                                    };
                                    return yield(ye = ue.getProvider()) === null || ye === void 0 ? void 0 : ye.request(ft)
                                }
                                return h0.includes(ae.toLowerCase()) ? (console.warn(`MetaMaskSDK connectWith method=${ae} -- not handled by the extension -- call separately`),
                ...
                if (U === le.METAMASK_CONNECTWITH)
                    try {
                        let ce = 0, ie = 5, ne = ({resolve: ge, reject: de}) => {
                            ce += 1;
                            let ye = a?.getConnector().getRPCMethodTracker()
                              , be = ye?.[se];
                            ...
                            void ge(be.result)) : be?.error ? (Y("[initializeMobileProvider: sendRequest()] found error", be.error),
                        ...
                        , ae, ue, ve = yield new Promise( (ge, de) => {
                            let ye = a?.getConnector().getRPCMethodTracker();
                            Y(`TRACKER: method ${se}`, ye),
                            ye?.[se].result ? (Y("[initializeMobileProvider: sendRequest()] found result", ye?.[se].result),
                            ge(ye?.[se].result)) : ye?.[se].error && (Y("[initializeMobileProvider: sendRequest()] found error", ye?.[se].error),
                            de(ye?.[se].error)),
                            ue = () => ne({
                                resolve: ge,
                                reject: de
...
var Ga = ({provider: e, sdkInstance: t}) => {
    if ("state"in e)
            ...
            return J(this, void 0, void 0, function*() {
                ...
                if (a.toLowerCase() === le.METAMASK_CONNECTWITH.toLowerCase() && Array.isArray(c))
                    return ( ({target: f, params: g}) => J(void 0, void 0, void 0, function*() {
                        ...
                        }) : h0.includes(v.toLowerCase()) ? (console.warn(`MetaMaskSDK connectWith method=${v} -- not handled by the extension -- call separately`),
                        S) : yield f.request({
                            method: v,
                            params: p
                        })
...
, Zo;
function c2({mustBeMetaMask: e, sdkInstance: t}) {
    return J(this, void 0, void 0, function*() {
        if (typeof window > "u")
        ...
        try {
            let n = yield new Promise( (r, i) => {
                ...
                , 500);
                window.addEventListener(Zo.Announce, s => {
                    let a = s
                      , {detail: {info: c, provider: l}={}} = a
                      , {name: u, rdns: d, uuid: h} = c ?? {};
                    Jm.test(h) && u.startsWith(fd.NAME) && fd.RDNS.includes(d) && (clearTimeout(o),
                    r(l))
                }
                ),
                window.dispatchEvent(new Event(Zo.Request))
            }
            );
            return Ga({
                provider: n,
...
var l2 = e => J(void 0, void 0, void 0, function*() {
    let {options: t} = e
      , {infuraAPIKey: n} = t;
    if (!n)
        return;
  ...
  , u2 = e => J(void 0, void 0, void 0, function*() {
    let {options: t} = e
      , {readonlyRPCMap: n} = t;
    if (n)
        try {
...
var yd = "INSTALLED"
  ...
  , f2 = function() {
    function e(t) {
        ...
        this.state = e.isMetaMaskInstalled() ? yd : vd;
        var a = e._detectBrowser();
        this.downloadUrl = a ? _d[a] : _d.DEFAULT,
        this._onMessage = this._onMessage.bind(this),
        ...
        s === e.FORWARDER_MODE.INJECT && sessionStorage.getItem(Qi) === "true" && e._injectForwarder(this.forwarderOrigin)
    }
    ...
    e.prototype._onMessageFromForwarder = function(t) {
        return d2(this, 0, void 0, function() {
            return h2(this, function(n) {
                switch (n.label) {
                case 0:
                    switch (this.state) {
                    case Ed:
    ...
    e.prototype.startOnboarding = function() {
        sessionStorage.setItem(Qi, "true"),
        this._openDownloadPage(),
        this._openForwarder()
    }
    ,
    e.prototype.stopOnboarding = function() {
        sessionStorage.getItem(Qi) === "true" && (this.forwarderMode === e.FORWARDER_MODE.INJECT && (console.debug("Removing forwarder"),
        e._removeForwarder()),
        sessionStorage.setItem(Qi, "false"))
    }
    ,
    ...
    e._injectForwarder = function(t) {
        ...
        r.setAttribute("id", Cd),
        n.insertBefore(r, n.children[0])
    }
    ,
    e._removeForwarder = function() {
        var t;
        (t = document.getElementById(Cd)) === null || t === void 0 || t.remove()
    }
    ,
    e._detectBrowser = function() {
        var t = u0.parse(window.navigator.userAgent);
...
var Ya = class {
  ...
  , m2 = ({link: e, debug: t, installer: n, terminate: r, connectWithExtension: i, preferDesktop: o, onAnalyticsEvent: s}) => {
    let a = null
      , c = null;
  ...
  , g2 = ({onDisconnect: e, debug: t}) => {
    let n = null
      ...
      , s = ({displayOTP: a}={
        ...
        n ? n.style.display = "block" : (r = new Jo({
            debug: t,
            sdkVersion: Vn.version
        }),
...
function v2(e, t, {initialCheck: n, connectWith: r}={}) {
...
var Ja = class {
    constructor(t) {
        ...
        t.modals.install || (t.modals.install = m2),
        t.modals.otp || (t.modals.otp = g2)
    }
    startConnection(t) {
        return J(this, void 0, void 0, function*() {
            return v2(this.state, this.options, t)
        })
    }
...
function b2(e) {
    ...
    return J(this, void 0, void 0, function*() {
        ...
        yield function(S) {
            ...
            return J(this, void 0, void 0, function*() {
                let {options: N} = S;
                ((E = N.storage) === null || E === void 0 ? void 0 : E.enabled) !== !0 || N.storage.storageManager || (N.storage.storageManager = yield d0(N.storage))
            })
        }(e),
        yield function(S) {
            return J(this, void 0, void 0, function*() {
                ...
                if (E.dappMetadata) {
                    ...
                    E.dappMetadata.base64Icon && E.dappMetadata.base64Icon.length > a2 && (console.warn("Invalid dappMetadata.base64Icon: Base64-encoded icon string length must be less than 163400 characters"),
        ...
        let {metamaskBrowserExtension: m, preferExtension: v, shouldReturn: p} = yield function(S) {
            ...
            return J(this, void 0, void 0, function*() {
                ...
                if (typeof window < "u" && window.ethereum && !(!((E = S.platformManager) === null || E === void 0) && E.isMetaMaskMobileWebView())) {
                    G = localStorage.getItem(Go) === "extension";
                    try {
                        z = yield c2({
                            mustBeMetaMask: !0,
                            sdkInstance: S
            ...
            yield function(S, E) {
                ...
                return J(this, void 0, void 0, function*() {
                    ...
                    S.remoteConnection = new Ja({
                        ...
                        ,
                        logging: U,
                        connectWithExtensionProvider: E === void 0 ? void 0 : () => pd(S),
...
var Sd = class extends _r.default {
    constructor(t={
        storage: {
            enabled: !0
        },
        ...
        this.options = t,
        this.options._source || (t._source = hd),
        this.init().then( () => {
        ...
        return function(t) {
            ...
            return J(this, void 0, void 0, function*() {
                if (!(!((n = t.platformManager) === null || n === void 0) && n.isMetaMaskMobileWebView())) {
                    if (e2 && (window.localStorage.removeItem(Go),
  ...
  , Tc = new WeakMap
  , Sn = e => Tc.get(e)
  , Rc = (e, t) => Tc.set(t.$lazyInstance$ = e, t)
  , kd = (e, t) => t in e
  , jn = (e, t) => (0,
console.error)(e, t)
  , la = new Map
  , go = new Map
  , g0 = "slot-fb{display:contents}slot-fb[hidden]{display:none}"
  ...
  , Qa = () => {
    Ad(xd),
    Ad(v0),
    (Xa = xd.length > 0) && Ke.raf(Qa)
}
  , Oc = e => (t => Promise.resolve(t))().then(e)
  , A2 = x2(v0)
  , Md = {}
  , Lc = e => (e = typeof e) == "object" || e === "function";
function b0(e) {
    var t, n, r;
...
function M2(e, t) {
    if (e.isOk) {
        let n = t(e.value);
        return n instanceof Promise ? n.then(r => ec(r)) : ec(n)
    }
    if (e.isErr) {
        let n = e.value;
        return w0(n)
...
, B = (e, t, ...n) => {
    let r = null
      ...
      , a = l => {
        for (let u = 0; u < l.length; u++)
            r = l[u],
            Array.isArray(r) ? a(r) : r != null && typeof r != "boolean" && ((i = typeof e != "function" && !Lc(r)) && (r = String(r)),
            i && o ? s[s.length - 1].$text$ += r : s.push(i ? Xo(null, r) : r),
            o = i)
    }
    ;
    if (a(n),
...
, Xo = (e, t) => ({
    ...
    forEach: (e, t) => e.map(Td).forEach(t),
    map: (e, t) => e.map(Td).map(t).map(P2)
}, Td = e => ({
    vattrs: e.$attrs$,
...
, as = e => Sn(e).$hostElement$, xn = (e, t, n) => {
    let r = as(e);
    return {
        emit: i => E0(r, t, {
            bubbles: !!(4 & n),
      ...
      , o = ( (s, a, c) => {
        ...
        d)
            if (typeof d == "string") {
                s = s.head || s;
                let h, f = Rd.get(s);
                if (f || Rd.set(s, f = new Set),
                !f.has(u)) {
                    {
                        h = Dt.createElement("style"),
                        h.innerHTML = d;
                        let g = (l = Ke.$nonce$) != null ? l : b0(Dt);
...
, _0 = (e, t) => "sc-" + e.$tagName$, Od = (e, t, n, r, i, o) => {
    if (n !== r) {
        let s = kd(e, t)
          , a = t.toLowerCase();
        if (t === "class") {
            ...
            e.setAttribute(t, r))
        } else if (t = t[2] === "-" ? t.slice(3) : kd(ss, a) ? a.slice(2) : a[2] + t.slice(3),
        n || r) {
            let c = t.endsWith(C0);
            t = t.replace(B2, ""),
            n && Ke.rel(e, t, n, c),
...
, N2 = /\s/, Ld = e => e ? e.split(N2) : [], C0 = "Capture", B2 = new RegExp(C0 + "$"), S0 = (e, t, n) => {
    let r = t.$elm$.nodeType === 11 && t.$elm$.host ? t.$elm$.host : t.$elm$
      , i = e && e.$attrs$ || Md
      , o = t.$attrs$ || Md;
    for (let s of Pd(Object.keys(i)))
        s in o || Od(r, s, i[s], void 0, n, t.$flags$);
    for (let s of Pd(Object.keys(o)))
        Od(r, s, i[s], o[s], n, t.$flags$)
}
;
function Pd(e) {
...
var k0 = !1
  ...
  , Ic = (e, t, n, r) => {
    ...
    if (i.$text$ !== null)
        ...
        if (wt || (wt = i.$tag$ === "svg"),
        o = i.$elm$ = Dt.createElementNS(wt ? "http://www.w3.org/2000/svg" : "http://www.w3.org/1999/xhtml", !k0 && C2 && 2 & i.$flags$ ? "slot-fb" : i.$tag$),
        wt && i.$tag$ === "foreignObject" && (wt = !1),
        S0(null, i, wt),
        o.getRootNode().querySelector("body") && _2 && (c => c != null)(yo) && o["s-si"] !== yo && o.classList.add(o["s-si"] = yo),
        i.$children$)
  ...
  , Id = (e, t, n, r, i, o) => {
    let s, a = e;
    for (a.shadowRoot && a.tagName === Pc && (a = a.shadowRoot); i <= o; ++i)
        r[i] && (s = Ic(null, n, i),
        s && (r[i].$elm$ = s,
        vo(a, s, t)))
}
  ...
  , qr = (e, t, n=!1) => {
    let r = t.$elm$ = e.$elm$
      ...
      , s = t.$tag$
      , a = t.$text$;
    a === null ? (S0(e, t, wt = s === "svg" || s !== "foreignObject" && wt),
    i !== null && o !== null ? ( (c, l, u, d, h=!1) => {
        let f, g = 0, m = 0, v = l.length - 1, p = l[0], S = l[v], E = d.length - 1, N = d[0], I = d[E];
        for (; g <= v && m <= E; )
            p == null ? p = l[++g] : S == null ? S = l[--v] : N == null ? N = d[++m] : I == null ? I = d[--E] : eo(p, N, h) ? (qr(p, N, h),
            p = l[++g],
            N = d[++m]) : eo(S, I, h) ? (qr(S, I, h),
            S = l[--v],
            I = d[--E]) : eo(p, I, h) ? (qr(p, I, h),
            vo(c, p.$elm$, S.$elm$.nextSibling),
            p = l[++g],
            I = d[--E]) : eo(S, N, h) ? (qr(S, N, h),
            vo(c, S.$elm$, p.$elm$),
            S = l[--v],
            N = d[++m]) : (f = Ic(l && l[m], u, m),
            N = d[++m],
            f && vo(p.$elm$.parentNode, f, p.$elm$));
        g > v ? Id(c, d[E + 1] == null ? null : d[E + 1].$elm$, u, d, m, E) : m > E && Nd(l, g, v)
    }
    )(r, i, t, o, n) : o !== null ? (e.$text$ !== null && (r.textContent = ""),
    Id(r, null, t, o, 0, o.length - 1)) : !n && S2 && i !== null && Nd(i, 0, i.length - 1),
    wt && s === "svg" && (wt = !1)) : e.$text$ !== a && (r.data = a)
}
  , vo = (e, t, n) => e?.insertBefore(t, n)
  , D2 = (e, t, n=!1) => {
    let r = e.$hostElement$
      , i = e.$cmpMeta$
      , o = e.$vnode$ || Xo(null, null)
      , s = (a = t) && a.$tag$ === O2 ? t : B(null, null, t);
    var a;
    if (Pc = r.tagName,
    n && s.$attrs$)
  ...
  , Nc = (e, t) => (e.$flags$ |= 16,
4 & e.$flags$ ? void (e.$flags$ |= 512) : (x0(e, e.$ancestorComponent$),
A2( () => $2(e, t))))
  , $2 = (e, t) => {
    let n = e.$hostElement$
      , r = (e.$cmpMeta$.$tagName$,
  ...
  , j2 = (e, t) => K2(e) ? e.then(t).catch(n => {
    console.error(n),
    t()
}
) : t()
  , K2 = e => e instanceof Promise || e && e.then && typeof e.then == "function"
  , U2 = (e, t, n) => we(void 0, null, function*() {
    var r;
    let i = e.$hostElement$
      , o = (e.$cmpMeta$.$tagName$,
    () => {}
  ...
  , F2 = e => {
    ...
    M0(t),
    Bc(r, "componentDidLoad"),
    n(),
    e.$onReadyResolve$(t),
    i || A0()),
    e.$onRenderResolve$ && (e.$onRenderResolve$(),
    e.$onRenderResolve$ = void 0),
    512 & e.$flags$ && Oc( () => Nc(e, !1)),
    e.$flags$ &= -517
}
  , A0 = e => {
    M0(Dt.documentElement),
    Oc( () => E0(ss, "appload", {
        detail: {
  ...
  , M0 = e => {
    var t;
    return e.classList.add((t = E2) != null ? t : "hydrated")
}
  , z2 = (e, t, n, r) => {
    let i = Sn(e);
    if (!i)
    ...
    l = n,
    u = r.$members$[t][0],
    n = l == null || Lc(l) ? l : 4 & u ? l !== "false" && (l === "" || !!l) : 1 & u ? String(l) : l;
  ...
  , q2 = (e, t, n, r) => we(void 0, null, function*() {
    let i;
    if (!(32 & t.$flags$)) {
        if (t.$flags$ |= 32,
        n.$lazyBundleId$) {
            let a = ( (l, u, d) => {
                ...
                return mp(`./${f}.entry.js`).then(m => (la.set(f, m),
                m[h]), jn)
            }
            )(n);
            if (a && "then"in a) {
  ...
  , tc = e => {
    Bc(e, "connectedCallback")
}
  , Bd = e => {
    Bc(e, "disconnectedCallback")
}
  , V2 = (e, t={}) => {
    var n;
    let r = () => {}
    , i = [], o = t.exclude || [], s = ss.customElements, a = Dt.head, c = a.querySelector("meta[charset]"), l = Dt.createElement("style"), u = [], d, h = !0;
    Object.assign(Ke, t),
              ...
              , E = class extends HTMLElement {
                ...
                connectedCallback() {
                    ...
                    h ? u.push(this) : Ke.jmp( () => (N => {
                        if (!(1 & Ke.$flags$)) {
                            ...
                            if (1 & I.$flags$)
                                I?.$lazyInstance$ ? tc(I.$lazyInstance$) : I?.$onReadyPromise$ && I.$onReadyPromise$.then( () => tc(I.$lazyInstance$));
                            else {
                                I.$flags$ |= 1;
                                {
                                    let z = N;
                ...
                disconnectedCallback() {
                    Ke.jmp( () => (N => we(this, null, function*() {
                        if (!(1 & Ke.$flags$)) {
                            let I = Sn(N);
                            I?.$lazyInstance$ ? Bd(I.$lazyInstance$) : I?.$onReadyPromise$ && I.$onReadyPromise$.then( () => Bd(I.$lazyInstance$))
                        }
                    }))(this))
                }
                componentOnReady() {
...
var W2 = Object.freeze({
    ...
    defineCustomElements: (e, t) => we(void 0, null, function*() {
        if (typeof window < "u")
            return yield void 0,
            V2([["mm-install-modal_3", [[1, "mm-install-modal", {
                link: [1],
  ...
  , Dc = ({className: e}, t) => B("div", {
    style: G2,
    class: e
}, t)
  , ua = ({Icon: e, text: t}) => B("div", {
    class: "flexContainer",
    style: {
        padding: "6",
        flexDirection: "row"
...
`), r = n.length, i = new Array(r), o;
    ...
    xy(t) {
        ...
        return t.x = Dd(t.x, this.width),
        t.y = Dd(t.y, this.height),
        t
    }
    rect(t, n, r) {
...
`)
  ...
  , Ud = ["low", "medium", "quartile", "high"]
  , Hd = ["numeric", "alphanumeric", "byte", "kanji", "eci"]
  , Q2 = [26, 44, 70, 100, 134, 172, 196, 242, 292, 346, 404, 466, 532, 581, 655, 733, 815, 901, 991, 1085, 1156, 1258, 1364, 1474, 1588, 1706, 1828, 1921, 2051, 2185, 2323, 2465, 2611, 2761, 2876, 3034, 3196, 3362, 3532, 3706]
  , eg = {
  ...
  , Ve = {
    ...
    alphabet: {
        numeric: Kd("0123456789"),
        alphanumerc: Kd("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ $%*+-./:")
    },
    lengthBits: (e, t) => ({
        numeric: [10, 12, 14],
  ...
  , nc = [ (e, t) => (e + t) % 2 == 0, (e, t) => t % 2 == 0, (e, t) => e % 3 == 0, (e, t) => (e + t) % 3 == 0, (e, t) => (Math.floor(t / 2) + Math.floor(e / 3)) % 2 == 0, (e, t) => e * t % 2 + e * t % 3 == 0, (e, t) => (e * t % 2 + e * t % 3) % 2 == 0, (e, t) => ((e + t) % 2 + e * t % 3) % 2 == 0]
  , oe = {
    tables: (e => {
        let t = ut(256, 0)
          , n = ut(256, 0);
...
function Fd(e, t, n, r) {
    ...
    return ng(e, t).encode(u)
}
function zd(e, t, n, r, i=!1) {
...
function R0(e, t="raw", n={}) {
    let r = n.ecc !== void 0 ? n.ecc : "medium";
    (function(u) {
        if (!Ud.includes(u))
            throw new Error(`Invalid error correction mode=${u}. Expected: ${Ud}`)
    }
    )(r);
    ...
    (function(u) {
        if (!Hd.includes(u))
            throw new Error(`Encoding: invalid mode=${u}. Expected: ${Hd}`);
        if (u === "kanji" || u === "eci")
            throw new Error(`Encoding: ${u} is not supported (yet?).`)
    }
    )(i),
    n.mask !== void 0 && function(u) {
        if (![0, 1, 2, 3, 4, 5, 6, 7].includes(u) || !nc[u])
    ...
    let c = function(u, d, h, f) {
        if (f === void 0) {
            ...
            for (let m = 0; m < nc.length; m++)
                g.add(rg(zd(u, d, h, m, !0)), m);
            f = g.get()
        }
        if (f === void 0)
...
var ig = ( () => {
    let e = class {
        ...
        render() {
            ...
            }, t("INSTALL_MODAL.INSTALL_META_MASK_EXTENSION"))))), B($c, {
  ...
  , og = ( () => {
    let e = class {
        ...
        render() {
            ...
            }, i("PENDING_MODAL.DISCONNECT")))), B($c, {
                version: r
            })))
        }
        get el() {
...
export {Un as CommunicationLayerPreference, Ue as ConnectionStatus, vr as DEFAULT_SERVER_URL, te as EventType, Te as MessageType, Sd as MetaMaskSDK, nt as MetaMaskSDKEvent, jt as PROVIDER_UPDATE_TYPE, qe as PlatformType, Fa as SDKProvider, Sd as default};
